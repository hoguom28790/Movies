  ...
  return (
    <div 
      className={isPseudoFS 
        ...
        // FIXED: Enforce strict 16:9 ratio and cap height for large monitors + avoid stretching
        : "w-full aspect-[16/9] h-auto min-h-[180px] max-h-[75vh] self-start relative shadow-cinematic-2xl bg-black overflow-hidden rounded-[32px] border border-white/5"
      } 
