...
export function PlaylistModal({ isOpen, onClose, movieSlug, movieTitle, posterUrl }: PlaylistModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div 
        className="bg-surface p-6 md:p-8 rounded-[32px] border border-white/10 shadow-2xl w-full max-w-md relative flex flex-col gap-6 animate-in zoom-in slide-in-from-bottom-4 duration-500 ease-out"
